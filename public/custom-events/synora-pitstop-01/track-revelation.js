 ...
 * Automatically unlocks on September 17, 2026 at 4:30 PM IST (16:30:00).
...
(function () {
  ...
  // ===========================================================================
  // Official Production Date: September 17, 2026 at 4:30 PM IST (UTC+05:30)
  // const PROD_REVEAL_TIMESTAMP = new Date("2026-09-17T16:30:00+05:30").getTime();
  const PROD_REVEAL_TIMESTAMP = new Date("2026-09-17T16:30:00+05:30").getTime();
  ...
  function resolveRevealTimestamp() {
    ...
    // Real official event countdown: September 17, 2026 at 4:30 PM IST
  ...
  function getIsRevealed() {
    ...
    // Strict automatic reveal based on target timestamp: 17 Sep 2026 at 4:30 PM IST
      ...
      hud.innerHTML = `
        ...
        <div class="hud-grid-body">
          <div class="hud-narrative-box">
            ...
            <p class="hud-subtext">
              Official challenge directives, problem statements, and domain briefs are locked under Race Control encryption. Full telemetry stream unlocks automatically at 04:30 PM on September 17, 2026.
            </p>
          </div>
          <div class="hud-clock-stage">
            ...
            <div class="hud-clock-target">
              AUTO-REVEAL: 17 SEPTEMBER 2026 // 04:30 PM IST
            </div>
          </div>
        </div>
      `;
    ...
    toast.innerHTML = `
      <div class="f1-toast-inner">
        ...
        <div>
          ...
          <p>Official Problem Statements PDF remains classified until the countdown reaches 00:00:00 (17 Sep 4:30 PM IST).</p>
        </div>
      </div>
    `;
