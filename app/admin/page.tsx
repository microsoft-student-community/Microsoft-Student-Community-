                ...
                <div className="bg-[#18181b]/40 backdrop-blur-xl border border-white/10 rounded-2xl p-6 md:p-8 mb-8 shadow-xl">
                  ...
                  <form onSubmit={handleCreateEvent} className="flex flex-col gap-5">
                    ...
                    <div className="p-5 bg-black/30 border border-white/5 rounded-2xl mt-4">
                      ...
                      <div className="flex flex-col gap-2">
                        <input type="url" name="external_registration_link" placeholder="e.g. https://lu.ma/event-name" className="p-3 bg-black/40 border border-white/10 focus:border-blue-500/50 rounded-xl text-white outline-none transition-all placeholder:text-white/20" />
