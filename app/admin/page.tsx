...
export default function AdminPage() {
  ...
  return (
    <div className="admin-workspace admin-spacious flex flex-col md:flex-row h-[100dvh] bg-[#09090b] text-[#f4f4f5] font-sans overflow-hidden">
      ...
      {/* Sidebar */}
      <aside className={`admin-sidebar fixed top-[61px] md:top-0 left-0 md:relative w-full md:w-[280px] bg-[#0c0c0e]/90 md:bg-[#0c0c0e]/60 backdrop-blur-2xl md:border-r border-white/5 flex flex-col p-6 z-40 h-[calc(100dvh-61px)] md:h-auto transition-all duration-300 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'} overflow-y-auto justify-between`}>
      ...
      {/* Main Area */}
      <main className="admin-main flex-1 overflow-y-auto p-6 pb-24 md:p-10 md:pb-10 relative z-10">
